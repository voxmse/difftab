...
public class INTEGER extends Hasher {
	...
	protected void getHash(Object o, byte[] hash, int hashOffset) throws Exception {
		if(o==null){
			...
			md.update(BigDecimal.valueOf((java.lang.Integer)o).stripTrailingZeros().toPlainString().getBytes(StandardCharsets.US_ASCII));
	...
	protected int getData(Object o, byte[] data, int dataOffset, int maxDataLength) throws Exception {
		if(o==null) return -1;
		final byte[] val=BigDecimal.valueOf((java.lang.Integer)o).stripTrailingZeros().toPlainString().getBytes(idCharset);
	...
	protected int getHashAndData(Object o,byte[] hash,int hashOffset,byte[] data,int dataOffset,int maxDataLength) throws Exception {
		if(o==null){
			...
			String strVal=BigDecimal.valueOf((java.lang.Integer)o).stripTrailingZeros().toPlainString();
