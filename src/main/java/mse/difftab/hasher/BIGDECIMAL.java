...
public class BIGDECIMAL extends Hasher {
	@Override
	public void getHash(Object o, byte[] hash, int hashOffset) throws Exception {
		if(o==null){
			...
			md.update(((java.math.BigDecimal)o).stripTrailingZeros().toPlainString().getBytes(StandardCharsets.US_ASCII));
	...
	public int getData(Object o, byte[] data, int dataOffset, int maxDataLength) throws Exception {
		...
		final byte[] val=((java.math.BigDecimal)o).stripTrailingZeros().toPlainString().getBytes(idCharset);
	...
	public int getHashAndData(Object o,byte[] hash,int hashOffset,byte[] data,int dataOffset,int maxDataLength) throws Exception {
		if(o==null){
			...
			String strVal=((java.math.BigDecimal)o).stripTrailingZeros().toPlainString();
